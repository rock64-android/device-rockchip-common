...
INSTALLED_2NDBOOTLOADER_TARGET := $(PRODUCT_OUT)/android.dtb

MOBILEVISOR_CONFIG_FLS = $(FLASHFILES_DIR)/mvconfig_smp.fls
...
$(SECBIN_TEMP)/%: $(FLASHFILES_DIR)/%.fls $(SECBIN_TEMP)
	$(FLSTOOL) -o $@ -x $<

$(SYSTEM_SEC_BIN_LIST): $(SECBIN_OUT)/%.secbin: $(SECBIN_TEMP)/% $(SECBIN_TEMP) $(SECBIN_OUT)
...
#MKIMAGED := $(wildcard $(INSTALLED_2NDBOOTLOADER_TARGET))
#ifeq ($(strip $(MKIMAGED)),)
#$(error Please run ./mkimage.sh <platform name>.dtb first)
#endif	
